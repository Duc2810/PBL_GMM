...
class EuclideanDistTracker:
    ...
    #TEXT FILE SUMMARY
    def end(self):
        file = open("C:\\Users\\trang\\Downloads\\record//SpeedRecord.txt", "a")
        file.write("\n-------------\n")
        file.write("-------------\n")
        file.write("KET QUA :\n")
        file.write("-------------\n")
        file.write("Tong so phuong tien phat hien duoc :\t"+str(self.count)+"\n")
        file.write("so phuong tien qua toc do :\t"+str(self.exceeded))
        file.close()
